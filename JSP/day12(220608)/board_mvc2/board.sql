...
create table board (
    ...
    regdate datetime default now(),
    readcount int default 0,
    constraint board_user_fk2 foreign key(userid) references user(userid)
);

insert into board (boardtitle, boardcontents, userid) values("테스트 제목 1","테스트 내용 1",'apple');
insert into board (boardtitle, boardcontents, userid) values("테스트 제목 2","테스트 내용 2",'banana');
insert into board (boardtitle, boardcontents, userid) values("테스트 제목 3","테스트 내용 3",'cherry');
