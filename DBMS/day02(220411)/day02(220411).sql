...
create table studylist (
	classcode int primary key,
    studentnum int,
    constraint studylist_timetable_fk foreign key(classcode) references timetable(classcode),
    constraint studylist_student_fk foreign key(studentnum) references student(studentnum)
);